		...
		<div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal" role="form" action="<?php echo site_url('Plan/update_plan');?>" method="post" enctype="multipart/form-data">                                    
                                           <div class="form-group">
                                            <input type="hidden" name ="update_id" value="<?php echo $edit_plans['int_plan_id'];?>">
	                                                <label class="col-md-4 control-label">Plan Name </label>
	                                                <div class="col-md-8">
	                                                    <input type="text" class="form-control" value="<?php echo $edit_plans['txt_plan_name'];?>" name="txt_plan_name">
	                                                </div>
	                                                <div class="col-md-6">
	                                             ...
	                                             <div class="form-group">
	                                                ...
	                                                <div class="col-md-8">
	                                                    <input type="text" class="form-control" value="<?php echo $edit_plans['dbl_cost'];?>" name="dbl_cost">
	                                                </div>
	                                                <div class="col-md-6">
            ...
            <div class="form-group">
             <label class="col-md-4 control-label">Date </label>
                <div class='col-md-8'>
                    <input type='text' class="form-control" id="datepicker" value="<?php echo $edit_plans['dt_date'];?>" name="date" />
